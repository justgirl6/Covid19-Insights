...
<?php
$fips = strip_tags($_GET['fips']);
$Province_State = strip_tags($_GET['ps']);
?>
...
success: function(res)
{
  ...
  var options = {'title':'Statistical Graphs of Covid-19 Data for <?php echo $Province_State; ?>', 'width':800, 'height':400,
 series: {
            0: { color: 'purple' },
            1: { color: 'navy' },
...
<br><br>
<h3><center>Statistical Graphs of Covid-19 Data for <b style='color:#800000;font-size:20px;'><?php echo $Province_State; ?></b>
</center></h3>
...
if($vertex_id ==''){
echo "<div style='background:red;color:white;padding:8px;border:none;'>No Records found for Province/State (<b style='color:#800000;font-size:20px;'><?php echo $Province_State; ?></b>) in  Tigergraph Database Yet..</div>";
exit();
}
