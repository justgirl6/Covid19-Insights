...
$data[] = array('Province/State', 'Confirmed Cases', 'Deaths', 'Recovered','Active', 'Incident_Rate');
...
$data[] = array($Province_State,(int)$Confirmed,(int)$Deaths,(int)$Recovered,(int)$Active,(int)$Incident_Rate);
